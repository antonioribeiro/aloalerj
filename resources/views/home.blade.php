...
@section('content')
    ...
    <a class="hiddenLink" id="home-chat" href="{!! url('chat/01-index') !!}" style="top: 1052px; left: 153px; height: 107px; width: 107px;" ></a>
    ...
    <a class="hiddenLink" id="home-messages" style="top: 1052px; left: 839px; height: 107px; width: 107px;">
        <span id="badgeHome" class="badge" v-show="badge" style="top: -40px; left: 45px;">@{{ badge }}</span>
    </a>
